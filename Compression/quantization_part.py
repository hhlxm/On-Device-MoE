...
Date: 2025-05-14 02:47:19
LastEditors: hhlxm 578723542@qq.com
LastEditTime: 2025-05-17 11:16:34
FilePath: /lxm/Compression/quantization_part.py
...
def parse_args():
    parser = argparse.ArgumentParser(description="Quantize a model using GPTQ with customizable parameters.")
...
def main():
    ...
    tokenizer = AutoTokenizer.from_pretrained("/home/fit/renju/WORK/lxm/models/DeepSeek_V2_Lite")
    ...
    model.save(f'/home/fit/renju/WORK/lxm/Compression/models/DeepSeek_V2_Lite-ex_attn{bits}bit')
