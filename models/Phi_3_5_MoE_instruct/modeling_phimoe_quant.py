        ...
        if not self.training and quant_num == self.top_k and not self.all_quant and routing_weights.shape[0] ==1:
            ...
            for expert_idx, expert in enumerate(self.experts):
                try:
                    ...
                    logging.warning(f"Full quantization failed for expert {expert_idx}: {e}")
                    raise
            self.all_quant = True
            ...
            if bottom_experts.numel() == 0:
                ...
                for expert_idx in bottom_experts.view(-1).unique():
                    ...
                    try:
                        ...
                        logging.warning(f"Quantization failed for expert {expert_idx}: {e}")
                        raise
...
class PhiMoEDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        hidden_states, router_logits = self.block_sparse_moe(hidden_states,quant_wbit,quant_num)
        hidden_states = residual + hidden_states
