...
def load_model_and_tokenizer(model_config):
    ...
    if type == 'pregate':
        from models.DeepSeek_V2_Lite.modeling_deepseek_pregate_predictor import DeepseekV2ForCausalLM
...
def load_data(tokenizer, data_config):
    ...
    if 'alpaca' in data_config["train_dataset_name"].lower():
        ...
        train_dataset = instruct_CustomDataset(data_config["train_dataset_name"], data_config['train_type'], tokenizer, max_length=data_config.get("max_length", 512))
        val_dataset = instruct_CustomDataset(data_config["test_dataset_name"], data_config['test_type'], tokenizer, max_length=data_config.get("max_length", 512))
    else :
