...
max_iterations=1
is_first_training=1
targeted_sparsity_list=(50 80 90)
...
#         --model hf \
#         --model_args pretrained=/home/fit/renju/WORK/lxm/models/Llama-2-7b-hf,trust_remote_code=True \
